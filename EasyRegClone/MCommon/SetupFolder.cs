...
namespace MCommon
{
	internal class SetupFolder
	{
		...
		{
			if (!CommonSQL.CheckColumnIsExistInTable("accounts", "device"))
			{
				CommonSQL.AddColumnsIntoTable("accounts", "device", 1);
			}
			if (!CommonSQL.CheckColumnIsExistInTable("accounts", "pass_old"))
			{
				CommonSQL.AddColumnsIntoTable("accounts", "pass_old", 1);
			}
			if (!CommonSQL.CheckColumnIsExistInTable("accounts", "status"))
			{
				CommonSQL.AddColumnsIntoTable("accounts", "status", 1);
			}
		}
		...
		{
			string str = "Nguyễn|Trần|Lê|Phạm|Hoàng|Phan|Vũ|Đặng|Bùi|Đỗ|Hồ|Ngô|Dương|Lý|Huỳnh|Võ";
			return str.Split(new char[] { '|' }).ToList<string>();
		}
		...
		public static string GetUseragentIPad(Random rd)
		{
			...
			return strs[rd.Next(0, strs.Count)];
		}

		public static List<string> GetUseragentIPad()
		{
			return new List<string>()
			{
				"Mozilla/5.0 (iPad; CPU OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148",
		...
		{
			Common.CreateFolder(Application.StartupPath + "\\Sessions");
			Common.CreateFolder(Application.StartupPath + "\\SessionTemp");
			Common.CreateFolder(Application.StartupPath + "\\SessionsTdata");
			Common.CreateFolder(Application.StartupPath + "\\SessionsTdataFail");
			Common.CreateFolder(Application.StartupPath + "\\SessionsFail");
		}
	}
}